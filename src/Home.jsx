...
import btnInicio from "./images/image2.png";
    ...
    >
      <div className="flex gap-6 px-4 w-full justify-center overflow-x-auto whitespace-nowrap pb-2">
        <Link
          ...
          style={{ ...buttonStyle(btnInicio), width: BTN_W, height: BTN_H }}
          aria-label="Inicio"
          title="Inicio"
        >
      ...
      <div className="mt-4 mb-10 px-8 py-4 rounded-2xl bg-white/45 backdrop-blur-md border border-white/60 shadow-lg">
        <h1 className="text-7xl lg:text-8xl font-black text-green-800 uppercase tracking-tighter leading-none drop-shadow-sm">
          GREEN LAB
        </h1>
      </div>
